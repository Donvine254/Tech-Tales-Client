...
export function Chromium(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 14 14"
      ...
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M13.75 7a6.75 6.75 0 0 1-6.725 6.75l2.824-4.892a3.4 3.4 0 0 0 .552-1.859c0-.643-.178-1.244-.488-1.757h3.269a.8.8 0 0 0 .32-.065c.162.58.248 1.191.248 1.823m-.914-3.394A6.75 6.75 0 0 0 7 .25c-1.941 0-3.691.82-4.923 2.131a.8.8 0 0 1 .162.195l1.698 2.94a3.4 3.4 0 0 1 3.3-1.91zM.25 7a6.75 6.75 0 0 0 5.199 6.571a.8.8 0 0 1 .09-.246l1.692-2.931A3.4 3.4 0 0 1 4.119 8.81a1 1 0 0 1-.075-.107L1.133 3.66A6.7 6.7 0 0 0 .25 7m8.393.947l.04-.061a1.902 1.902 0 1 0-.108.18z"
        clipRule="evenodd"></path>
    </svg>
  );
}
export function Voice(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}>
      <title>voice options</title>
      <circle cx="14.3548" cy="19.496" r="4.934" />
      <path d="M24.7339 33.2758v1.6906a1.641 1.641 0 0 1-1.6447 1.6446H6.1447A1.641 1.641 0 0 1 4.5 34.9664V33.2758c2.1586-7.0207 18.973-5.8163 20.2339 0Z" />
      <path d="M25.258 20.877v5.0323" />
      <path d="M29.8186 16.2116V30.5745" />
      <path d="M34.3791 11.3891V35.3972" />
      <path d="M43.5 20.877v5.0323" />
      <path d="M38.94 16.2116V30.5745" />
    </svg>
  );
}
