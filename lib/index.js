...
import { revalidateBlogs, revalidatePage, updateUserRole } from "./actions";
...
export async function handleRoleUpdate(id, role, username) {
  if (role === "admin") {
    Swal.fire({
      icon: "warning",
      text: `Do you want to demote ${username}? This action cannot be undone.`,
    ...
    Swal.fire({
      icon: "warning",
      text: `Do you want to make ${username} an admin? This action cannot be undone.`,
