...
const registerApi = "http://127.0.0.1:9393/user";
const blogsApi = "http://127.0.0.1:9393/blogs";
const commentsApi = 'http://127.0.0.1:9393/user'
...
export function postComment(setComments, commentData) {
  Axios.post(commentsApi, comment)
...
export function deleteBlog(blogId, setBlogs) {
  const url=`http://127.0.0.1:9393/blogs/${blogId}`
  console.log(url)
  Axios.delete(url)
    .then((response) => {
