...
export function deleteBlog(blogId, slug, setBlogs) {
  ...
  Swal.fire({
    ...
    customClass: {
      confirmButton:
        "px-2 py-1 mx-2 bg-red-500 text-red-500 rounded-md hover:text-white hover:bg-red-500",
...
export async function handleSignOut() {
  Swal.fire({
    ...
    customClass: {
      confirmButton:
        "px-2 py-1 mx-2 rounded-md bg-red-500 text-red-500 hover:text-white hover:bg-red-500",
