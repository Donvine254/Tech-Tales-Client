      ...
      {blog ? (
        <div key={blog.id}>
          {blog.image && (
            <ImageWithFallback
              image={blog.image}
              fallbackSrc={`https://res.cloudinary.com/dipkbpinx/image/upload/b_rgb:f9efef,e_auto_color,f_auto,q_100/c_fit,g_center,l_text:Arial_60_bold:${blog.title},co_rgb:ffffff,w_2000,x_50,y_-100/v1725017389/tech-tales/cover-images/gdbbtzgydsntdtzblwjt.webp`}
            />
          )}
