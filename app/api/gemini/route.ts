...
- For each code response, wrap it in a pre with a class corresponding to its language, for example class=language-javascript, class=language-typescript etc. Short codes that need to be highlighted can just be put into <code> tags.
