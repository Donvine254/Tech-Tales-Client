...
export default function Create({
  ...
  // Save shortcut (Ctrl+S / Cmd+S) & Focus Mode (Ctrl+Shift+F / Cmd+Shift+F)
  useEffect(() => {
  ...
  return (
    <section className="relative">
      ...
      />
      <form
        className={`mx-auto px-2 sm:px-6 lg:px-8 py-6 ${focusMode ? "max-w-5xl" : "max-w-7xl"}`}>
        ...
        {!focusMode ? (
          ...
          <div className="space-y-4">
            {/* Hide distracting elements and focus on just writing */}
            <TitleSection
              title={blogData.title}
              onTitleChange={handleTitleChange}
              status={formStatus}
