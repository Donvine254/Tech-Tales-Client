...
import { handleForgetPassword } from "@/lib/actions/forget-password";
...
export default function Page() {
  ...
  /*_________________________function to handle forgetting password________________*/
  async function handleSubmit(data: { password: string }) {
    ...
    setStatus("loading");
    const res = await handleForgetPassword(auth_token, data.password);
    ...
    if (res.success) {
      ...
      setStatus("error");
      if (res.error === "error-token") {
        // Token is bad/expired — show the error state UI
