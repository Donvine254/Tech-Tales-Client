  ...
  const values = [
    {
      ...
      title: "Inclusivity",
      description:
        "We celebrate diversity and strive to create a welcoming space for all tech enthusiasts.",
    },
    {
      icon: Zap,
      title: "Empowerment",
      description:
        "We empower our community members to share their stories, connect with others, and grow their skills.",
    },
    {
      icon: Heart,
      title: "Collaboration",
      description:
        "We believe in the power of collaboration and encourage our community to support and learn from one another.",
    },
    {
      icon: Target,
      title: "Diversity",
      description:
        "Amplifying voices from all backgrounds to create inclusive tech narratives.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <p className="text-sm sm:text-lg mx-auto text-primary/90 max-w-2xl leading-relaxed">
              We&apos;re on a mission to democratize technology knowledge and
              make the digital world more accessible to everyone, one story at a
              time
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 min-h-[400px]">
          <div className="p-4 md:p-8">
            ...
            <div className="text-muted-foreground text-lg leading-relaxed space-y-6">
              <p>
                At TechTales, our mission is to create an inclusive and
                welcoming community where tech enthusiasts from all walks of
                life can connect, share their stories, and learn from one
                another.
              </p>
              <p>
                ...
                the tech industry. By fostering a safe and supportive
                environment, we aim to inspire the next generation of tech
                leaders and empower them to pursue their passions.
              </p>
              <p>
                We believe that what you read and write matters. Words can
                divide or empower us, inspire or discourage us. In a world where
                the most sensational and surface-level stories often win,
                we&apos;re building a system that rewards depth, nuance, and
              ...
              <p className="hidden lg:block">
                ...
                somewhere in between, I invite you to join our community and be
                a part of this incredible journey. Share your experience with
                others and provide the resources you never had!
              </p>
            </div>
          </div>
          {/* founder card */}
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow max-w-md">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm mb-6">
                    ...
                    challenges of navigating the industry. TechTales is a space
                    where we celebrate diversity, empower each other, and learn
                    from one another&apos;s unique experiences.
                  </p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 bg-background">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {values.map((value, index) => (
            <div
              key={index}
              className="border-blue-600 bg-blue-100 text-blue-900 dark:text-white dark:border-blue-500 dark:bg-blue-900/20 border p-6 rounded-xl shadow-lg text-center hover:shadow-xl transition-shadow">
              <div className="flex justify-center mb-4">
                <div className="bg-blue-50 border border-blue-300 dark:border-blue-500 p-3 rounded-full ">
        ...
        <div className="flex justify-center">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-sm mb-6">
                Former tech journalist with 10+ years covering emerging
                technologies, passionate about making tech accessible to
                everyone.
              </p>
              <div className="flex space-x-3">
                <Button
                  className="bg-blue-600 hover:bg-blue-700 w-full text-white cursor-pointer"
                  asChild>
                  <Link href="mailto:donvinemugendi@gmail.com">
                    {" "}
                    <Mail className="h-4 w-4" />
                    Hire Me
                  </Link>
