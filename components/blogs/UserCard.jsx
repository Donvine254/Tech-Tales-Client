...
export default function UserCard({ author }) {
  ...
  return (
    <div className=" bg-slate-50 absolute border shadow w-fit px-4 py-2 rounded-md xsm:w-full min-w-[250px] z-50">
      ...
      <p className="font-medium text-sm text-gray-600 xsm:text-sm">About</p>
      <p className="font-medium text-blue-600 my-1 text-xs md:text-sm p-1 bg-gray-200 rounded-sm">
      ...
      <Link
        ...
        prefetch
        className="text-sm text-sky-400 hover:text-sky-600 cursor-pointer my-2 whitespace-nowrap">
