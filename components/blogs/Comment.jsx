            ...
            <div className="py-1 flex items-center gap-4 flex-wrap">
              ...
              {user && comment.authorId === user.id ? (
                <>
                  ...
                  <DeleteBtn
                    handleClick={() => deleteComment(comment.id, setComments)}
                  />
                </>
                ...
                <>
                  ...
                  <HideButton
                    handleClick={() => hideOrFlagComment("HIDDEN", comment.id)}
                  />
                  <FlagButton
                    handleClick={() => hideOrFlagComment("FLAGGED", comment.id)}
                  />
                </>
                ...
                <>
                  ...
                  <ReplyButton handleClick={() => setIsReplying(comment.id)} />
                  <HideButton
                    handleClick={() => hideOrFlagComment("HIDDEN", comment.id)}
                  />
                  <FlagButton
