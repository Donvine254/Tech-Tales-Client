...
export const PreviewDialog = ({
	...
	return (
		<Dialog open={open} onOpenChange={onOpenChange}>
			...
			<DialogContent
				className="rounded-2xl shadow-2xl w-full  max-w-7xl gap-0 min-w-full h-full overflow-hidden flex flex-col p-0"
			...
			>
										...
										<div className="absolute top-0 left-0 right-0 h-11  bg-white dark:bg-accent shadow z-10 flex items-center justify-between px-6 text-primary text-sm font-medium">
											...
											<div className="flex items-center gap-x-1.5">
												...
												>
													...
													<path
														fill="currentColor"
														d="M20 8a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-2h2v-4h-2z"
													></path>
												</svg>
											</div>
										</div>
				...
				{/* mobile view */}
				<div className="md:hidden w-full h-[calc(100%-48px)] overflow-y-auto overflow-x-hidden bg-white dark:bg-accent/90 p-2 pt-6">
					<div className="max-w-4xl mx-auto">
						<BlogBody />
					</div>
				</div>
