        ...
        <div className="flex items-center space-x-3 mb-4">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center space-x-3 text-xs text-accent-foreground">
              ...
              {blog.audio && (
                <div
                  className="flex items-center gap-1 px-2 py-0.5 rounded-full bg-primary/10 dark:bg-stone-100 text-xs font-medium cursor-pointer text-blue-500 "
                  title="listen to this blog">
                  <AudioLinesIcon className="h-3 w-3" />
                  <Link href={`/read/${blog.path}`} prefetch={false}>
                    Listen
                  </Link>
                </div>
              )}
