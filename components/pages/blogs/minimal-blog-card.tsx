        ...
        <div className="flex-1 min-w-0 space-y-3 order-2 md:order-1 flex flex-col">
          ...
          {blog.status === "PUBLISHED" || blog.status === "ARCHIVED" ? (
            <Link
              ...
              className="group"
              title={blog.title ?? ""}>
              <h3 className="text-base sm:text-lg font-semibold font-grotesk text-foreground group-hover:text-primary transition-colors line-clamp-2 leading-snug cursor-pointer hover:underline">
                {blog.title ?? ""}
              </h3>
            </Link>
          ) : blog.status === "DRAFT" ? (
            <Link
              ...
              className="group"
              title={blog.title ?? ""}>
              <h3 className="text-base sm:text-lg font-semibold text-foreground font-grotesk group-hover:text-primary transition-colors line-clamp-2 leading-snug cursor-pointer hover:underline">
                {blog.title ?? "Untitled Post"}
              </h3>
            </Link>
          ) : (
            <h3 className="font-grotesk text-base sm:text-lg font-semibold text-foreground group-hover:text-primary transition-colors line-clamp-2 leading-snug ">
              {blog.title ?? "Untitled Post"}
            </h3>
          )}
          {/* Body Preview */}
