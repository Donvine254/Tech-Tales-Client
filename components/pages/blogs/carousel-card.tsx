    ...
    <div
      ...
      <div className="flex flex-col">
        ...
        <div className="p-4 space-y-3">
          <h3 className="font-bold font-grotesk text-lg hover:underline leading-snug">
    ...
    <div
      ...
      <div className="aspect-video relative hidden md:block">
        ...
        <div className="absolute inset-0 p-6 flex flex-col justify-end text-white space-y-1">
          <Link
            href={`/read/${post.path}`}
            className="drop-shadow-2xl font-bold text-base text-shadow-lg line-clamp-1 font-grotesk hover:underline hover:underline-offset-4 transition-all duration-300">
            {post.title}
          </Link>
