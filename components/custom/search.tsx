...
export default function SearchBar({ className }: { className: string }) {
	...
	const handleVoiceSearch = () => {
		// biome-ignore lint: manual window check for SSR environments
			...
			>
				...
				<div className="relative">
					<CommandInput
						...
						value={query}
						className="truncate pr-12 text-ellipsis "
				...
				<CommandList>
					<CommandEmpty className="p-2">
						<Button
							variant="outline"
							className="cursor-pointer w-full relative flex items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-hidden select-none bg-accent capitalize border-none"
							onClick={() => {
