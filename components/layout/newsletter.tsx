    ...
    <section className="text-accent-foreground border-t border-border mt-4">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <div
            role="alert"
            className="relative w-full px-4 py-3 grid has-[>svg]:grid-cols-[calc(var(--spacing)*4)_1fr] grid-cols-[0_1fr] has-[>svg]:gap-x-9 sm:has-[>svg]:gap-x-6 gap-y-0.5 [&>svg]:size-12 sm:[&>svg]:size-8 [&>svg]:translate-y-0.5 [&>svg]:text-current items-start mt-4 mx-auto max-w-md">
            <svg
