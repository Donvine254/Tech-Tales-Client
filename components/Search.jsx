  ...
  return (
    <form className="relative py-2 flex items-center" onSubmit={handleSearch}>
      <input
        ...
        className="rounded-full bg-slate-200 dark:bg-gray-800 p-2 pl-10 px-4 w-full focus:bg-gray-600 dark:hover:bg-gray-600 text-white focus:outline-none text-xl hidden md:block"
      />
