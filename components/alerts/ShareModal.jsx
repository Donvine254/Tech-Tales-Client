...
export default function ShareModal({ slug, title, image, blogId }) {
  ...
  return (
    <dialog
      ...
      className="modal duration-300 ease-in-out backdrop-blur-3xl backdrop-brightness-150 rounded-md max-w-sm xsm:mx-2">
      <section className="bg-white rounded-md border xsm:max-w-[98%] relative ">
