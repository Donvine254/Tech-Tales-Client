const giphyApiKey="kyOZdQ3OjsRHw1o8kp34h6FRvzyP3Div",randomApiUrl=`https://api.giphy.com/v1/gifs/trending?api_key=${giphyApiKey}&limit=50&offset=${Math.floor(100*Math.random())}&rating=g`;let handleSubmit;tinymce.PluginManager.add("gif",(e,t)=>{let i=()=>e.windowManager.open({title:"Insert GIF",body:{type:"panel",items:[{type:"htmlpanel",name:"gifDisplay",html:`<div>
