tinymce.PluginManager.add("ai",function(t,e){let n=()=>{t.windowManager.open({title:"AI Assistant",body:{type:"panel",items:[{type:"htmlpanel",name:"responsePanel",html:`<div id="ai-response-container" style="padding: 10px; max-height:250px; overflow-y:scroll;"> 
...
</div>`,n=document.getElementById("ai-response-container");n.style.border="1px solid gray",n.style.borderRadius="5px",n.innerHTML=e,document.getElementById("insert-btn").addEventListener("click",()=>{insertContent(t)})}).catch(t=>{console.error("Error fetching AI response:",t),alert("Failed to fetch AI response.")}),t.setData({prompt:""})}})};return t.ui.registry.addButton("ai",{icon:"ai",tooltip:"Ask AI",onAction:function(){n()}}),t.ui.registry.addMenuItem("ai",{text:"AI Assistant",onAction:function(){n()}}),{getMetadata:function(){return{name:"AI Assistant",url:"http://exampleplugindocsurl.com"}}}});const insertContent=t=>{console.log(t),tinymce.activeEditor.insertContent(`<div>${t.message}</div>`),tinymce.activeEditor.windowManager.close()};