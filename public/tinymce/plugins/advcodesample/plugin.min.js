...
</svg>`),e.ui.registry.addButton("advcodesample",{icon:"advcode-sample",tooltip:"Insert Code Sample",shortcut:"meta+Alt+C",onAction:o}),e.ui.registry.addMenuItem("advcodesample",{text:"Insert Code Sample",icon:"advcode-sampl",onAction:o})});