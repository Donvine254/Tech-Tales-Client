...
`;document.body.insertAdjacentHTML("beforeend",t);let o=()=>{let e=ace.edit("editor"),t=e.getTheme(),o=document.getElementById("theme");"ace/theme/tomorrow"===t?(e.setTheme("ace/theme/tomorrow_night"),o.textContent="Light Theme",o.style.backgroundColor="#f2f3f4",o.style.color="#333"):(e.setTheme("ace/theme/tomorrow"),o.textContent="Dark Theme",o.style.backgroundColor="#222",o.style.color="#fff")};document.getElementById("increaseFontBtn").addEventListener("click",n),document.getElementById("decreaseFontBtn").addEventListener("click",i),document.getElementById("theme").addEventListener("click",o),document.getElementById("format").addEventListener("click",()=>{ace.config.loadModule("ace/ext/beautify",function(e){e.beautify(ace.edit("editor").session)})}),document.getElementById("saveCode").addEventListener("click",()=>{let t=ace.edit("editor");e.setContent(t.getValue()),d()}),document.getElementById("closeDialogBtn").addEventListener("click",d)},o=12,n=()=>{let e=ace.edit("editor");o<26&&(o+=2,e.setFontSize(o))},i=()=>{let e=ace.edit("editor");o>10&&(o-=2,e.setFontSize(o))},r=()=>{ace.config.loadModule("ace/ext/language_tools",function(){let t=ace.edit("editor");t.session.setMode("ace/mode/html"),t.setOptions({wrap:!0,indentedSoftWrap:!1,enableAutoIndent:!0,selectionStyle:"text",behavioursEnabled:!0,showLineNumbers:!0,showPrintMargin:!1,enableBasicAutocompletion:!0,enableSnippets:!0,enableLiveAutocompletion:!0,autoScrollEditorIntoView:!0,foldStyle:"markbegin",showFoldWidgets:!0,fontSize:"14px",tabSize:2,theme:"ace/theme/tomorrow"}),t.setValue(e.getContent({source_code:!0}))}),document.getElementById("customDialog").showModal()},d=()=>{document.getElementById("customDialog").close()};t(),e.ui.registry.addButton("code",{icon:"sourcecode",tooltip:"Source code",shortcut:"meta+Space",onAction:r}),e.ui.registry.addMenuItem("code",{text:"Source Code",icon:"sourcecode",onAction:r}),e.on("keydown",function(e){" "===e.key&&(e.ctrlKey||e.metaKey)&&(e.preventDefault(),document.getElementById("customDialog").showModal())})});